package com.github.microkibaco.bearlive.register;
...
import com.github.microkibaco.bearlive.editprofile.EditProfileActivity;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void register() {
        ...
        if (accountStr.length() <= 8 ||
            ...
            Toast.makeText(this, "小熊账号和密码,不能小于8位数", Toast.LENGTH_SHORT).show();
            return;
        }

        if (isStr2Num(accountStr)
                || isStr2Num(passwordStr)) {
            Toast.makeText(this, "小熊账号和密码,不能全为数字哦~~~", Toast.LENGTH_SHORT).show();
            return;
        }
