package com.github.microkibaco.bearlive.createroom;
...
import com.github.microkibaco.bearlive.hostlive.HostLiveActivity;
import com.github.microkibaco.bearlive.model.RoomInfo;
import com.github.microkibaco.bearlive.utils.ImgUtils;
import com.github.microkibaco.bearlive.utils.PicChooserHelper;
...
public class CreateLiveActivity extends AppCompatActivity {
    ...
    private void requestCreateRoom() {
        ...
        if (param.userId == null ||
                ...
                param.userName == null ||
                param.liveTitle == null ||
                param.liveCover == null) {
            Toast.makeText(this, "亲,网络不咋滴呀~", Toast.LENGTH_SHORT).show();
            return;
        }
